...
import graph_aug_for_er.experiments
...
def load_config(name):
    with pkg_resources.open_text(graph_aug_for_er.experiments, f"{name}.yml") as config_file:
...
def load_global_config():
    with pkg_resources.open_text(graph_aug_for_er, "config.yml") as config_file:
        config = yaml.safe_load(config_file)
