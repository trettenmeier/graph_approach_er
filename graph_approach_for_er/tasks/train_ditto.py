...
sys.path.append(os.path.join(graph_approach_for_er.__path__[0], "matching_systems", "ditto"))
from graph_approach_for_er.matching_systems.ditto.train_ditto import main as ditto_main
